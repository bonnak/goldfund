                ...
                $interval(function() {
                    $http({
                        ...
                        vm.quotes.forEach(function(quote){
                            var new_quote = data.query.results.rate.find(function(el){ return el.id == quote.id; });
                            quote.ask = new_quote.Ask;
                            quote.bid = new_quote.Bid;
                            quote.date = new_quote.Date;
                            quote.name = new_quote.Name;
                            quote.old_rate = quote.rate;
                            quote.rate = new_quote.Rate;
                            quote.time = new_quote.Time;
                        });
                    });
                }, 2000);
