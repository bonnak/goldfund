    ...
    public function run()
    {
        ...
        $service = [
            [
                ...
                by all mining participants.</p><p style="font-size:24px; font-weight:bold">What is Bit Company Trading Mining</p>
                <p style="text-align:justify">Bit Company Trading Enter in Bitcoin Mining at the end of 2014. They got to know
                each other by using the same platform for buying and selling Bitcoins. Bit Company Trading company
                and its user base grew, new mining farms were built up and several additional people
                hired, specifically programmers and engineers. The current members of Bit Company Trading come from
                different scientific disciplines, but our common faith in cryptocurrencies has brought
                us together.Bit Company Trading strong believers in the future of digital currencies and Bit Company Trading
                love being part of this growing community! Bit Company Trading having large number of bitcoin Machine
                on it own farm. Bit Company Trading Share his Profits to the investor.</p>'
            ],
            [
                'title' => 'Forex Trading',
                'slug'  => 'forex-trading',
                'description' => ' <p style="font-size:24px; font-weight:bold">What is Forex Trading</p>
                    ...
                    <p style="font-size:24px; font-weight:bold">What is Bit Company Trading Trading</p>
                     <p style="text-align:justify">
                     Bit Company Trading Trade Responsibly: Bit Company Trading are complex financial products that are traded
                     on margin. Trading Bit Company Trading carries a high level of risk since leverage can work both
                     to your advantage and disadvantage. As a result, Bit Company Trading may suitable for all
                     investors because you may not lose all your invested capital. Bit Company Trading should not
                     risk more than you are prepared to lose. Before deciding to trade, Bit Company Trading need to
                     ensure that the risks involved taking into account your investment objectives and
                     level of experience. Past performance of Bit Company Trading is a reliable indicator of future
                     results. Most Bit Company Trading have no set maturity date. Hence, a Bit Company Trading position matures
                     on the date you choose to close an existing open position. Seek independent advice,
                     if necessary. Please read Bit Company Trading full ‘Risk Disclosure Statement’.</p>
                     ...
                     level of market resolution. Designed specifically for the trading of Bit Company Trading,
                     Bit Company Trading is a trading platform allowing traders to place orders while having access
                     to full market depth. Bit Company Trading provides its traders on the Bit Company Trading trading platform
            ...
            [
                ...
                'description' => '<p style="font-size:24px; font-weight:bold">What is Gold Trading</p>
                    ...
                    <p style="font-size:24px; font-weight:bold">What is Bit Company Trading Gold Trading</p>
                    <p style="text-align:justify"> Bit Company Trading Trade Responsibly: Bit Company Trading are complex
                    financial products that are traded on margin. Trading Bit Company Trading carries a high level
                    of risk since leverage can work both to your advantage and disadvantage. As a result,
                    Bit Company Trading may suitable for all investors because you may not lose all your invested
                    capital. Bit Company Trading should not risk more than you are prepared to lose. Before deciding
                    to trade, Bit Company Trading need to ensure that the risks involved taking into account your
                    investment objectives and level of experience. Past performance of Bit Company Trading is a
                    reliable indicator of future results. Most Bit Company Trading have no set maturity date.
                    Hence, a Bit Company Trading position matures on the date you choose to close an existing
                    open position. Seek independent advice, if necessary. Please read Bit Company Trading full
                    ‘Risk Disclosure Statement’.</p>
                    <p style="text-align:justify">A relative newcomer to the world of charting platforms,
                    cTrader has already developed a loyal following among traders looking for an added
                    level of market resolution. Designed specifically for the trading of Bit Company Trading,
                    Bit Company Trading is a trading platform allowing traders to place orders while having access
                    to full market depth. Bit Company Trading provides its traders on the Bit Company Trading trading
