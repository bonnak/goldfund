    ...
    <header id="home" class="header">
        ...
        <div class="container">
            ...
            <div class="buttons inpage-scroll">
                <a href="v1.3.1.html#works" class="btn btn-primary custom-button red-btn">Our Works</a>
                <a href="v1.3.1.html#pricingtable" class="btn btn-primary custom-button green-btn">Our Packages</a>
            </div>
